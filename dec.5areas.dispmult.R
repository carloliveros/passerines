...
trfn = "rs-25-lognor.combined.ann.newick.tre"
geogfn = "biogeo.5areas.txt"
...
BioGeoBEARS_run_object$dispersal_multipliers_fn = "manual_dispersal_multipliers0.txt"
...
runslow = TRUE
resfn = "Passerines_DEC_5areas_dispmult0_v1.Rdata"
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "Passerines_DEC_5areas_dispmult0_v1.pdf"
pdf(pdffn, width=7, height=20)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS Passerines_DEC_5areas_dispmult0"
...
resfn = "Passerines_DEC+J_5areas_dispmult0_v1.Rdata"
runslow = TRUE
if (runslow)
    {
...
# PDF plots
#######################################################
pdffn = "Passerines_DEC+J_5areas_dispmult0_v1.pdf"
pdf(pdffn, width=7, height=20)

#######################################################
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS Passerines_DEC+J_5areas_dispmult0"
...
# load the saved result.
runslow = TRUE
resfn = "Passerines_DEC_5areas_dispmult1_v1.Rdata"
if (runslow)
    {
    res = bears_optim_run(BioGeoBEARS_run_object)
    res    
...
# PDF plots
#######################################################
pdffn = "Passerines_DEC_5areas_dispmult1_v1.pdf"
pdf(pdffn, width=7, height=20)

#######################################################
# Plot ancestral states - DEC
#######################################################
analysis_titletxt ="BioGeoBEARS Passerines_DEC_5areas_dispmult1"
...
resfn = "Passerines_DEC+J_5areas_dispmult1_v1.Rdata"
runslow = TRUE
if (runslow)
    {
    #sourceall("/Dropbox/_njm/__packages/BioGeoBEARS_setup/")
...
# PDF plots
#######################################################
pdffn = "Passerines_DEC+J_5areas_dispmult1_v1.pdf"
pdf(pdffn, width=7, height=20)

#######################################################
# Plot ancestral states - DECJ
#######################################################
analysis_titletxt ="BioGeoBEARS Passerines_DEC+J_5areas_dispmult1"
